  ...
  return (
    <main className="app-shell">
      <header className="topbar">
        <div><div className="brand-row"><span className="brand-mark">FX</span><h1>FlowExtract</h1><span className="version">v0.1 dev</span></div><p>Local first AI assisted document extraction, validation and human review.</p></div>
